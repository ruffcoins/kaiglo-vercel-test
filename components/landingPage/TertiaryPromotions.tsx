...
const TertiaryPromotions = () => {
  return (
    <div className="bg-white grid lg:grid-cols-2 items-center lg:space-x-12 space-y-6 lg:space-y-0 lg:mx-8 xl:mx-14 mx-4 rounded-lg lg:py-20 px-6 py-10 lg:px-20 2xl:px-40">
